#ifndef CALPHADAB1CD2OLD_H
#define CALPHADAB1CD2OLD_H

#include "CalphadFreeEnergy.h"

class CalphadAB1CD2Old : public CalphadFreeEnergy
{
public:
  CalphadAB1CD2Old();

  virtual void parameterize(Real & R, std::vector<Real> & low, std::vector<Real> & high, std::vector<Real> & mix, std::vector<Real> L0, std::vector<Real> L1, std::vector<Real> Pure1);
