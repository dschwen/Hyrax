 ...
 [./concentration]
  ...
  [./n1]
    ...
    [./InitialCondition]
     ...
     radius = 1.8
     int_width = 0.9
     x_positions = '130 129  82 88 37 88  22 64 81  66 80  5  25  25 101  15 42 15 116 110'
     y_positions = ' 70 146 140 93 99 72 143 54 23 109 55 11 116 117  88 100 98 26  81   2'
...
[Postprocessors]
  ...
  [./VolumeFraction]
    ...
    output = file
    bubble_volume_file = SS_size_distribution_5.csv
    Avrami_file = Avrami_5.csv
    threshold = 0.75
    variable = n1
    mesh_volume = Volume
...
[Output]
  file_base = testSiteSaturationGuoSS_5
