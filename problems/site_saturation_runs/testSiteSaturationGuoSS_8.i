 ...
 [./concentration]
  ...
  [./n1]
    ...
    [./InitialCondition]
     ...
     radius = 2.0
     int_width = 1.0
     x_positions = '81 35 122 19  30 144 40  74  6  22 37 139 21 101 97 114 110 13 70  31'
     y_positions = '28 15 126 91 110   7 51 114 16 129  9  20 62  61 70 141  74 96 83 103'
...
[Postprocessors]
  ...
  [./VolumeFraction]
    ...
    output = file
    bubble_volume_file = SS_size_distribution_8.csv
    Avrami_file = Avrami_8.csv
    threshold = 0.75
    variable = n1
    mesh_volume = Volume
