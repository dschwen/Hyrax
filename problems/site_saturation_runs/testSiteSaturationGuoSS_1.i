 ...
 [./concentration]
  ...
  [./n1]
    ...
    [./InitialCondition]
     ...
     radius = 2.0
     int_width = 1.0
     x_positions = '  3  13 14 25 35  45 51  56 59 69  80  84 87 90 101 114 124 131 139 146'
     y_positions = '127 110 57 11 45 141 28 104 87 48 120  77 55 17  43  63 100 130  37  94'
...
[Postprocessors]
  ...
  [./VolumeFraction]
    ...
    output = file
    bubble_volume_file = SS_size_distribution_1.csv
    Avrami_file = Avrami_1.csv
    threshold = 0.75
    variable = n1
    mesh_volume = Volume
...
[Output]
  file_base = testSiteSaturationGuoSS_1
