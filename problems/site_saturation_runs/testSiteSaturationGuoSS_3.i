 ...
 [./concentration]
  ...
  [./n1]
    ...
    [./InitialCondition]
     ...
     radius = 1.8
     int_width = 0.9
     x_positions = '105  68  38 39  14 86 114 113 40 123 133 97 16 52  8 29  3 147 140 125'
     y_positions = '144 119 131  7 123 59  29 132 42 124  36 65 35  6 74 54 13  18  10  37'
...
[Postprocessors]
  ...
  [./VolumeFraction]
    ...
    output = file
    bubble_volume_file = SS_size_distribution_3.csv
    Avrami_file = Avrami_3.csv
    threshold = 0.75
    variable = n1
    mesh_volume = Volume
...
[Output]
  file_base = testSiteSaturationGuoSS_3
