 ...
 [./concentration]
  ...
  [./n1]
    ...
    [./InitialCondition]
     ...
     radius = 1.8
     int_width = 0.9
     x_positions = '86  9 145 107 111  36 120 81  6 75 126  92 18 96 16 93 32 45 48 56'
     y_positions = '78 78  38  14  67 104  90 63 68 17  91 102 18  6 34 68 28 69 61 11'
...
[Postprocessors]
  ...
  [./VolumeFraction]
    ...
    output = file
    bubble_volume_file = SS_size_distribution_4.csv
    Avrami_file = Avrami_4.csv
    threshold = 0.75
    variable = n1
    mesh_volume = Volume
...
[Output]
  file_base = testSiteSaturationGuoSS_4
