#This simulation crashes on my box at after the variable norms are displayed for time step 2.
# exec command: mpirun -np 8 ./hyrax-oprof -e -i MeshSolutionModify_segfault.i
...
[Postprocessors]
 ...
 [./Elastic_energy]
  ...
  [./VolumeFraction]
    ...
    output = both
    bubble_volume_file = Calphad_singleParticle2_vol.csv
    Avrami_file = Calphad_singleParticle2_Avrami.csv
    threshold = 0.5
    variable = n
    mesh_volume = Volume
...
[Adaptivity]
  ...
  [./Markers]
    ...
    [../]
     ...
     [./combo]
       type = ComboMarker
       markers = 'EFMHM_1 EFMHM_2 EFMHM_3 EFMHM_4'
     [../]
  [../]
